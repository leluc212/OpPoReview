export const translations = {
  vi: {
    ...
    legalPrivacy: {
      ...
      terms: 'Điều Khoản Dịch Vụ',
      termsDesc: 'Đọc các điều khoản và điều kiện',
      viewTerms: 'Xem Điều Khoản',
      privacy: 'Chính Sách Bảo Mật',
      privacyDesc: 'Tìm hiểu cách chúng tôi bảo vệ dữ liệu của bạn',
      viewPolicy: 'Xem Chính Sách',
      cookies: 'Chính Sách Cookie',
      cookiesDesc: 'Hiểu về việc sử dụng cookie của chúng tôi',
      dataExport: 'Tải Dữ Liệu',
      dataExportDesc: 'Tải xuống bản sao dữ liệu cá nhân của bạn',
    ...
    register: {
      ...
      employerFeature5: 'Thanh toán an toàn qua ví điện tử của nền tảng',
  ...
  en: {
    ...
    security: {
      ...
      changePasswordDesc: 'Update your password regularly to secure your account',
    ...
    legalPrivacy: {
      ...
      cookiesDesc: 'Understand our use of cookies',
      dataExport: 'Data Download',
    ...
    profile: {
      ...
      uploadPhotoHelp: 'JPG, PNG or GIF. Max size 5MB',
      bio: 'Bio',
      experience: 'Experience',
      education: 'Education',
      skills: 'Skills',
    ...
    register: {
      ...
      candidateDescription: 'Find jobs fast - Get matching jobs near you',
      candidateFeature1: 'Get AI-powered matching job suggestions',
      candidateFeature2: 'Apply with just one click',
      candidateFeature3: 'Get urgent jobs based on your free time',
      candidateFeature4: 'Track jobs and receive payments via wallet',
      candidateButton: 'Create Candidate Account',
      employerTitle: "I'm an Employer",
      employerDescription: 'Find candidates quickly for work shifts',
      employerFeature1: 'Unlimited job postings',
      employerFeature2: 'Post urgent jobs and find people instantly',
      employerFeature3: 'AI system suggests matching candidates',
      employerFeature4: 'Manage candidates and shifts easily',
      employerFeature5: 'Safe payment via platform digital wallet',
    ...
    underDevelopment: {
      ...
      message: 'This feature is currently under development and will be available soon. Thank you!!!',
      button: 'Got It',
    },
  },
};
