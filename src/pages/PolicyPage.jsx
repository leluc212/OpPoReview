    ...
    <Wrapper $isDark={isDarkMode}>
      ...
      <Container>
        ...
        <Card $isDark={isDarkMode}>
          ...
          <UL $isDark={isDarkMode}>
            <li>{vi ? 'Điều chỉnh, bổ sung hoặc thay đổi điều khoản sử dụng bất kỳ lúc nào. Người dùng sẽ được thông báo trước ít nhất 03 ngày.' : 'Adjust, supplement, or change terms of use at any time. Users will be notified at least 03 days in advance.'}</li>
