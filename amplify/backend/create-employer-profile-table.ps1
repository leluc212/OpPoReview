# Create EmployerProfiles DynamoDB table
$TABLE_NAME = "EmployerProfiles"
$REGION = "ap-southeast-1"

Write-Host "Creating EmployerProfiles DynamoDB table..." -ForegroundColor Cyan
Write-Host ""
...
Write-Host "1. Run deploy-employer-api.ps1 to create Lambda and API Gateway" -ForegroundColor White
Write-Host "2. Test API using test-employer-api.ps1" -ForegroundColor White
